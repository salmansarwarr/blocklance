                            ...
                            {gigs && gigs?.length > 0 ? (
                                gigs?.map((gig) => (
                                    <Link href={`/gig/${gig._id}`} class="p-4 md:w-1/3" key={gig._id}>
                                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:bg-blue-100">
                                            <img
                                ...
                                <h1 className="pl-3">No active gigs</h1>
                            )}
                        </div>
                    </div>
                </div>
